	...
	async function load() {
		...
		try {
			...
			if (!dashboardResponse.ok || !profileResponse.ok) {
				const body = await (dashboardResponse.ok ? profileResponse : dashboardResponse).json().catch(() => ({}));
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						"aria-label": `Thông báo chưa đọc: ${dashboard?.summary.unreadNotifications ?? 0}`,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { name: "bell" }), dashboard?.summary.unreadNotifications ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: dashboard.summary.unreadNotifications }) : null]
