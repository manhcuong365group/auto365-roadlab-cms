			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							className: "workspace-button workspace-button--ghost",
							href: `/workspace/cases/${encodeURIComponent(caseId)}/history`,
							children: "Lịch sử revision"
						}),
						data.case.workflowStatus === "archived" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							className: "workspace-button workspace-button--ghost",
							disabled: saving,
							onClick: () => void transitionStatus("restore"),
							children: "Khôi phục"
						}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							className: "workspace-button workspace-button--ghost",
							disabled: saving,
							onClick: () => {
								if (window.confirm("Huỷ case này? Case sẽ chuyển sang lưu trữ và ẩn khỏi bài đã xuất bản (nếu có), có thể khôi phục sau.")) transitionStatus("archive");
							},
							children: "Huỷ case"
						})
					]
