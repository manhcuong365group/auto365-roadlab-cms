...
import Link from "./link-C-ariCHD.js";
import { n as getCaseContentType, t as caseContentTypeOptions } from "./case-content-types-BwbiOG91.js";
import { n as useRouter } from "./navigation-DbgvjWuQ.js";
//#region app/workspace/cases/page.tsx
var import_react = /* @__PURE__ */ __toESM(require_react(), 1);
var import_jsx_runtime = require_jsx_runtime();
function NewCaseForm({ onClose, onCreated }) {
	const [contentType, setContentType] = (0, import_react.useState)("case");
	const [branchRef, setBranchRef] = (0, import_react.useState)("");
	const [vehicleRef, setVehicleRef] = (0, import_react.useState)("");
	const [productRef, setProductRef] = (0, import_react.useState)("");
	...
	async function submit() {
		...
		try {
			...
			setCreateError(reason instanceof Error ? reason.message : "Không thể tạo case.");
		} finally {
			setCreating(false);
		}
	}
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Tạo case mới" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					type: "button",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Loại nội dung" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", {
							value: contentType,
							onChange: (event) => setContentType(event.target.value),
							children: caseContentTypeOptions.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
								value: item.value,
								children: item.label
							}, item.value))
						})]
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
						className: "workspace-field",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Chi nhánh" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							value: branchRef,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
						className: "workspace-field",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Xe" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							value: vehicleRef,
							onChange: (event) => setVehicleRef(event.target.value),
							placeholder: "VD: Ford Ranger"
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
						className: "workspace-field",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Sản phẩm" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							value: productRef,
							onChange: (event) => setProductRef(event.target.value),
							placeholder: "VD: Bi Laser X9"
						})]
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				...
				disabled: creating || !branchRef.trim() || !vehicleRef.trim() || !productRef.trim(),
				onClick: submit,
				children: creating ? "Đang tạo…" : "Tạo case"
			})
		]
	});
}
...
function CasesPage() {
	...
	const [showNewCase, setShowNewCase] = (0, import_react.useState)(false);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				] }), !showNewCase ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					type: "button",
					className: "workspace-button",
					onClick: () => setShowNewCase(true),
					children: "+ Tạo case mới"
				}) : null]
			}),
			showNewCase ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NewCaseForm, {
				onClose: () => setShowNewCase(false),
				onCreated: (caseId) => router.push(`/workspace/cases/${encodeURIComponent(caseId)}`)
			}) : null,
