...
function CasesPage() {
	...
	const visibleCases = (0, import_react.useMemo)(() => cases.filter((item) => {
		return `${item.caseCode} ${item.branchRef}`.toLocaleLowerCase("vi-VN").includes(query.trim().toLocaleLowerCase("vi-VN")) && (status === "all" || item.workflowStatus === status);
	}), [
		cases,
		query,
		status
			...
			children: [
				...
				!loading && !error && cases.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
					...
					visibleCases.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "workspace-empty workspace-empty--card",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "Không tìm thấy case phù hợp." }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Thử đổi từ khóa hoặc trạng thái lọc." })]
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
