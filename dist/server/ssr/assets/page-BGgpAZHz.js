...
function EditUserPanel({ user, onClose, onSaved }) {
	...
	const [status, setStatus] = (0, import_react.useState)(user.status);
	const [role, setRole] = (0, import_react.useState)(user.roles[0]?.role ?? "content");
	const [branchRef, setBranchRef] = (0, import_react.useState)(user.roles[0]?.branchRef ?? "*");
	...
	async function submit() {
		...
		try {
			...
			setSaveError(reason instanceof Error ? reason.message : "Không thể cập nhật tài khoản.");
		} finally {
			setSaving(false);
		}
	}
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", { children: ["Sửa tài khoản · ", user.email] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					type: "button",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
						className: "workspace-field",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Trạng thái" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
							value: status,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Đặt lại mật khẩu (bỏ trống nếu không đổi)" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							type: "text",
							value: newPassword,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				...
				disabled: saving || !displayName.trim() || newPassword.length > 0 && newPassword.length < 8,
				onClick: submit,
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Chỉ vai trò Sếp mới tạo, sửa và xem được danh sách tài khoản." })
			...
			editingUser ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EditUserPanel, {
				user: editingUser,
				onClose: () => setEditingId(null),
				onSaved: () => {
					setEditingId(null);
					setNotice(`Đã cập nhật tài khoản ${editingUser.email}.`);
					load();
				}
			}) : null,
			...
			!loading && !error ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "workspace-table workspace-table--full workspace-table--users",
				role: "table",
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
