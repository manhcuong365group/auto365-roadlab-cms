...
import { n as useSearchParams } from "./navigation-CyrWHFg-.js";
...
function LoginPage() {
	...
	const [password, setPassword] = (0, import_react.useState)("Auto365-Content-2026!");
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "Tài khoản test nhanh" }), testAccounts.map(([account, role]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						onClick: () => {
							setEmail(account);
							setPassword(account === "content@auto365.test" ? "Auto365-Content-2026!" : account === "oa@auto365.test" ? "Auto365-OA-2026!" : account === "seo-lead@auto365.test" ? "Auto365-SEO-2026!" : account === "it@auto365.test" ? "Auto365-IT-2026!" : "Auto365-Boss-2026!");
						},
