...
function getDraftSecret() {
	return "d315a2a7-1dd6-4cdd-acf6-3309273e8dd4";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "fb93d2a7-bcd2-4ee7-bfaa-085e5c387f35";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "fb93d2a7-bcd2-4ee7-bfaa-085e5c387f35") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "fb93d2a7-bcd2-4ee7-bfaa-085e5c387f35",
		rootBoundaryId
	});
}
/**
