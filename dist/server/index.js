globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/case-content-types-QL6dA80t.js","assets/navigation-Djl3lzEW.js","assets/road-lab-draft-Dqw3chzx.js","assets/case-preview-BoaT49a1.js","assets/page-Bf_xYL9n.js","assets/page-DN0i8hIw.js","assets/case-editor-DTLUbtrp.js","assets/page-D1EbiPl9.js","assets/page-pnvJdn0K.js","assets/page-CfIZIc4S.js","assets/page-B1X5z7RL.js","assets/page-BGBlPu-d.js","assets/sidebar-5X31W8q5.js","assets/topbar-DW0BsD2X.js","assets/layout-segment-context-DMMB0Fot.js","assets/link-qvPGAt7z.js","assets/router-BMUG3li4.js"];
...
function getDraftSecret() {
	return "e95b602b-d48d-4380-ab9b-fd6f58ed0cf9";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "6f63570a-48e2-47c2-87a2-31f8b595b791";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "6f63570a-48e2-47c2-87a2-31f8b595b791") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "6f63570a-48e2-47c2-87a2-31f8b595b791",
		rootBoundaryId
	});
}
/**
...
async function GET$10(request, context) {
	try {
		...
		const { listCaseAssignments } = await import("./assets/case-lab-operations-z38fCYk9.js");
...
async function PUT$1(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { assignCaseReviewer } = await import("./assets/case-lab-operations-z38fCYk9.js");
...
var route_exports$14 = /* @__PURE__ */ __exportAll({ GET: () => GET$9 });
async function GET$9(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { listCaseAudit } = await import("./assets/case-lab-operations-z38fCYk9.js");
...
async function GET$8(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { getCaseDraft } = await import("./assets/case-lab-operations-z38fCYk9.js");
...
async function PUT(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { saveCaseDraft } = await import("./assets/case-lab-operations-z38fCYk9.js");
...
async function GET$7(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { listCaseFeedback } = await import("./assets/case-lab-operations-z38fCYk9.js");
...
async function POST$5(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { createCaseFeedback } = await import("./assets/case-lab-operations-z38fCYk9.js");
...
async function POST$4(request, context) {
	try {
		...
		const { resolveCaseFeedback } = await import("./assets/case-lab-operations-z38fCYk9.js");
...
async function POST$3(request, context) {
	try {
		...
		const { markNotificationRead } = await import("./assets/case-lab-operations-z38fCYk9.js");
...
async function GET$5(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getDashboard } = await import("./assets/case-lab-operations-z38fCYk9.js");
...
async function GET$3(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getMyProfile } = await import("./assets/case-lab-operations-z38fCYk9.js");
...
async function PATCH(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { updateMyProfile } = await import("./assets/case-lab-operations-z38fCYk9.js");
...
async function GET$2(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { listMyNotifications } = await import("./assets/case-lab-operations-z38fCYk9.js");
...
async function GET$1(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getOperationsReport } = await import("./assets/case-lab-operations-z38fCYk9.js");
