globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/case-content-types-QL6dA80t.js","assets/navigation-CX15Vbmw.js","assets/road-lab-draft-Dqw3chzx.js","assets/case-preview-BFbCIOa9.js","assets/page-CG2ktVbH.js","assets/page-D8cx7_b2.js","assets/case-editor-hpTq8rda.js","assets/page-DTn5Z8um.js","assets/page-QbUBGE0C.js","assets/page-BGsvamE0.js","assets/page-BdZtVSX5.js","assets/page-oy0eaWYN.js","assets/sidebar-BApbKIg7.js","assets/topbar-LKJFEpXM.js","assets/layout-segment-context-BxWHXcGM.js","assets/link-DiUrqR5B.js","assets/router-3DipaNFN.js"];
import { B as __commonJSMin, H as __toESM, V as __exportAll, a as caseRevisions, d as users, l as urlRegistry, n as authSessions, o as cases } from "./assets/schema-DZfcEeh9.js";
import { a as eq, i as and, n as getDb, o as gt } from "./assets/db-FbqKt8Jd.js";
import { a as parseFollowup, c as parseQc, d as getCaseContentType, f as normalizeCaseContentType, i as parseFaqs, l as parseRelated, m as apiErrorResponse, n as normalizeCaseDraft, o as parseListLines, p as CaseLabApiError, r as getRoadLabMediaUrls, s as parseMetrics, u as parseTimeline } from "./assets/case-draft-BfMTiHQc.js";
...
function getDraftSecret() {
	return "4036efeb-81e3-4d9e-b4e3-92ee53d73234";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "b6e4fce3-1202-4376-acdd-53af3c6364d0";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "b6e4fce3-1202-4376-acdd-53af3c6364d0") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "b6e4fce3-1202-4376-acdd-53af3c6364d0",
		rootBoundaryId
	});
}
/**
...
async function requireCaseLabActor(request) {
	...
	const [{ getDb }, { userRoles, users }] = await Promise.all([import("./assets/db-FbqKt8Jd.js").then((n) => n.t), import("./assets/schema-DZfcEeh9.js").then((n) => n.c)]);
	const db = getDb();
...
async function GET$10(request, context) {
	try {
		...
		const { listCaseAssignments } = await import("./assets/case-lab-operations--uJhh7x5.js");
...
async function PUT$2(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { assignCaseReviewer } = await import("./assets/case-lab-operations--uJhh7x5.js");
...
var route_exports$15 = /* @__PURE__ */ __exportAll({ GET: () => GET$9 });
async function GET$9(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { listCaseAudit } = await import("./assets/case-lab-operations--uJhh7x5.js");
...
async function GET$8(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { getCaseDraft } = await import("./assets/case-lab-operations--uJhh7x5.js");
...
async function PUT$1(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { saveCaseDraft } = await import("./assets/case-lab-operations--uJhh7x5.js");
...
async function GET$7(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { listCaseFeedback } = await import("./assets/case-lab-operations--uJhh7x5.js");
...
async function POST$5(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { createCaseFeedback } = await import("./assets/case-lab-operations--uJhh7x5.js");
...
var route_exports$12 = /* @__PURE__ */ __exportAll({ PUT: () => PUT });
...
async function PUT(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { transitionCaseStatus } = await import("./assets/case-lab-operations--uJhh7x5.js");
...
async function POST$4(request, context) {
	try {
		...
		const { resolveCaseFeedback } = await import("./assets/case-lab-operations--uJhh7x5.js");
...
async function POST$3(request, context) {
	try {
		...
		const { markNotificationRead } = await import("./assets/case-lab-operations--uJhh7x5.js");
...
var route_exports$8 = /* @__PURE__ */ __exportAll({ POST: () => POST$1 });
...
async function GET$5(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getDashboard } = await import("./assets/case-lab-operations--uJhh7x5.js");
...
async function GET$3(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getMyProfile } = await import("./assets/case-lab-operations--uJhh7x5.js");
...
async function PATCH(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { updateMyProfile } = await import("./assets/case-lab-operations--uJhh7x5.js");
...
async function GET$2(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { listMyNotifications } = await import("./assets/case-lab-operations--uJhh7x5.js");
...
async function GET$1(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getOperationsReport } = await import("./assets/case-lab-operations--uJhh7x5.js");
