globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/navigation-C_IYOB5f.js","assets/page-DCG4guWa.js","assets/page-CTdf3TLW.js","assets/case-editor-DWK0iQV6.js","assets/page-3VexKe1w.js","assets/page-UcTfElAP.js","assets/page-DrR5t0JE.js","assets/page-CJToNlGG.js","assets/page-BpG3HF-q.js","assets/sidebar-D4WgSXLN.js","assets/image-DXw0wdHx.js","assets/layout-segment-context-rhUWb6Yf.js","assets/link-BEvXvw6h.js","assets/router-D3-7UmxM.js"];
import { B as __exportAll, V as __toESM, n as authSessions, u as users, z as __commonJSMin } from "./assets/schema-DgFLUafw.js";
import { a as eq, i as and, n as getDb, o as gt } from "./assets/db-BlSdbD93.js";
import { n as CaseLabApiError, r as apiErrorResponse, t as normalizeRoadLabDraft } from "./assets/road-lab-draft-CPzFeWGX.js";
...
function getDraftSecret() {
	return "3bf17e28-e8fd-470d-9b9e-025746211fb6";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "38772d2e-e031-450f-98df-e8bf58f853c4";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "38772d2e-e031-450f-98df-e8bf58f853c4") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "38772d2e-e031-450f-98df-e8bf58f853c4",
		rootBoundaryId
	});
}
/**
...
async function requireCaseLabActor(request) {
	...
	const [{ getDb }, { userRoles, users }] = await Promise.all([import("./assets/db-BlSdbD93.js").then((n) => n.t), import("./assets/schema-DgFLUafw.js").then((n) => n.c)]);
	const db = getDb();
...
async function GET$9(request, context) {
	try {
		...
		const { listCaseAssignments } = await import("./assets/case-lab-operations-CSUfsCVN.js");
...
async function PUT$1(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { assignCaseReviewer } = await import("./assets/case-lab-operations-CSUfsCVN.js");
...
async function GET$8(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { listCaseAudit } = await import("./assets/case-lab-operations-CSUfsCVN.js");
...
function readDraftInput(value) {
	...
	if (content.publication.title.trim().length < 3 || content.publication.title.length > 180) throw new CaseLabApiError("VALIDATION_ERROR", "Tiêu đề cần từ 3 đến 180 ký tự.", 400);
	if (content.publication.summary.length > 600 || content.publication.answerFirst.length > 5e3 || content.evidence.resultSummary.length > 5e3) throw new CaseLabApiError("VALIDATION_ERROR", "Nội dung Road Lab vượt giới hạn cho phép.", 400);
...
async function GET$7(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { getCaseDraft } = await import("./assets/case-lab-operations-CSUfsCVN.js");
...
async function PUT(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { saveCaseDraft } = await import("./assets/case-lab-operations-CSUfsCVN.js");
...
async function GET$6(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { listCaseFeedback } = await import("./assets/case-lab-operations-CSUfsCVN.js");
...
async function POST$4(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { createCaseFeedback } = await import("./assets/case-lab-operations-CSUfsCVN.js");
...
async function POST$3(request, context) {
	try {
		...
		const { resolveCaseFeedback } = await import("./assets/case-lab-operations-CSUfsCVN.js");
...
async function POST$2(request, context) {
	try {
		...
		const { markNotificationRead } = await import("./assets/case-lab-operations-CSUfsCVN.js");
...
function WorkspaceLayout({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(sidebar_default, {}), children]
	});
}
...
var page_exports$11 = /* @__PURE__ */ __exportAll({ default: () => CaseReviewPage });
...
var camryCase = {
	identity: {
		...
		published: "2026-08-08T08:30:00+07:00",
		publishedDisplay: "08/08/2026",
		updated: "2026-08-10T17:30:00+07:00",
		updatedDisplay: "10/08/2026",
		dataDateDisplay: "10/08/2026",
		location: "Auto365.vn - Trụ Sở Chính",
		status: "published",
		section: "Cẩm nang ánh sáng ô tô",
		sectionUrl: "https://auto365.vn/cam-nang-anh-sang-o-to",
		author: {
			name: "Vinh",
			role: "Team Content Auto365"
		},
		reviewer: {
			name: "Nguyễn Quang Đạo",
			role: "Rà soát kỹ thuật phụ kiện điện tử ô tô"
		}
	},
	vehicle: {
		make: "Toyota",
	...
	sources: [{
		name: "Tài liệu sản phẩm X-Light / 365Group",
		dateModified: "2026-08-10"
	}, {
		name: "Hồ sơ thi công Toyota Camry 2014 2.5Q tại Auto365.vn - Trụ Sở Chính",
		dateModified: "2026-08-10"
	}],
	seo: {
		...
		keywords: [
			"Toyota Camry 2014 lắp bi gầm",
			"X-Light F10 Turbo V2",
			"bi gầm 4300K",
			"case xe thật Auto365"
		]
	},
	...
	evidenceStates: [
		{
			label: "Đã xác nhận thi công",
			note: "Hồ sơ đúng ca Camry 2014 2.5Q",
			tone: "verified"
		},
		{
			label: "Đã nghiệm thu tại xưởng",
			note: "Cos/Pha, pát và điện đã kiểm tra",
			tone: "workshop"
		},
		{
			label: "Chưa hậu kiểm 7–30 ngày",
			note: "Không tự tạo phản hồi sau sử dụng",
			tone: "pending"
		}
	],
	decisionFacts: [
		{
			label: "CẤU HÌNH",
			value: "F10 Turbo V2 · 4300K",
			note: "01 cặp / 02 đèn"
		},
		{
			label: "CAN THIỆP",
			value: "Có tháo cản",
			note: "Gia công trên bộ gá rời"
		},
		{
			label: "GIÁ SẢN PHẨM",
			value: "6.000.000 VNĐ",
			note: "Chưa VAT · chưa phải tổng bill"
		},
		{
			label: "BẢO HÀNH",
			value: "24 tháng",
			note: "Theo công bố nhà sản xuất"
		}
	],
	fitment: [
		{
			label: "Sản phẩm & vị trí",
			value: "X-Light F10 Turbo V2 tại hốc đèn gầm",
			proof: "case",
			proofLabel: "Đúng ca"
		},
		{
			label: "Nhiệt màu đã chọn",
			value: "4300K — đi tỉnh, cần màu trung tính",
			proof: "case",
			proofLabel: "Đúng ca"
		},
		{
			label: "Pát / bộ gá",
			value: "Pát kèm sản phẩm, gia công trên bộ gá rời",
			proof: "case",
			proofLabel: "Đúng ca"
		},
		{
			label: "Tháo cản",
			value: "Có, áp dụng trong ca này",
			proof: "case",
			proofLabel: "Đúng ca"
		},
		{
			label: "Cắt sửa xe",
			value: "Không ghi nhận cắt sửa chi tiết nguyên bản",
			proof: "case",
			proofLabel: "Theo hồ sơ"
		},
		{
			label: "Relay / cầu chì",
			value: "Có relay và cầu chì bảo vệ nguồn",
			proof: "case",
			proofLabel: "Đúng ca"
		},
		{
			label: "Logic kích hoạt",
			value: "Có công tắc; hồ sơ không lưu logic chi tiết",
			proof: "unknown",
			proofLabel: "Thiếu chi tiết"
		},
		{
			label: "Đèn gầm trước nâng cấp",
			value: "Hồ sơ chưa đủ dữ liệu để công bố",
			proof: "unknown",
			proofLabel: "Chưa có"
		}
	],
	productMetrics: [
		...
		{
			label: "Kích thước lens",
			value: "3.0 inch",
			note: "Thấu kính sản phẩm"
		},
		{
			label: "Nguồn sáng",
			value: "6 + 1 + 1 chip",
			note: "LED chính + Osram hỗ trợ pha"
		},
		{
			label: "Điện áp",
			value: "12–16V",
			note: "Dải vận hành công bố"
		},
		{
			label: "Kháng nước/bụi",
			value: "IP68",
			note: "Chỉ áp dụng cho sản phẩm"
		}
	],
	media: {
		hero: {
	...
	timeline: [
		{
			...
			text: "Đối chiếu hốc đèn, điểm bắt pát, nguồn điện, cảm biến và khoảng trống phía sau."
		},
		{
			title: "Khóa cấu hình",
			text: "Chốt F10 Turbo V2 4300K theo nhu cầu đi tỉnh và vùng sáng trung tính."
		},
		{
			title: "Tháo cản & chuẩn bị gá",
			text: "Tháo cản trong đúng ca này; hoàn thiện pát trên bộ gá rời."
		},
		{
			title: "Lắp đèn & bảo vệ nguồn",
			text: "Cố định đèn, bố trí dây, relay và cầu chì theo phương án đã duyệt."
		},
		{
			title: "Căn chỉnh Cos/Pha",
			text: "Kiểm tra độ cân bằng hai bên và hướng chiếu sau lắp."
		},
		{
			title: "QC & bàn giao",
			text: "Rà soát pát, điện, Cos/Pha và cảnh báo trên xe tại thời điểm bàn giao."
		}
	],
	inspection: [
		{
			label: "Cos",
			result: "Hoạt động sau căn chỉnh"
		},
		{
			label: "Pha",
			result: "Hoạt động sau căn chỉnh"
		...
		{
			label: "Cân bằng hai bên",
			result: "Đã kiểm tra"
		},
		{
			label: "Cảnh báo điện",
			result: "Không ghi nhận tại nghiệm thu"
		},
		{
			label: "Pát / bộ gá",
			result: "Đã kiểm tra độ chắc chắn"
		},
		{
			label: "Relay / cầu chì",
			result: "Đã kiểm tra"
	...
	faq: [
		{
			q: "Ca Camry 2014 này có phải tháo cản không?",
			a: "Có. Hồ sơ ca xe ghi nhận kỹ thuật viên đã tháo cản để thao tác. Câu trả lời này chỉ áp dụng cho đúng ca Camry 2014 2.5Q trong bài."
		},
		{
			q: "Vì sao chủ xe chọn 4300K?",
			a: "Chủ xe thường đi tỉnh và muốn màu sáng trung tính để bổ sung vùng sáng phía trước trong điều kiện thiếu sáng. Đây là lý do của đúng ca, không phải khuyến nghị mặc định cho mọi xe."
		},
		{
			q: "Giá 6 triệu đã gồm công lắp và VAT chưa?",
			a: "Chưa. 6.000.000 VNĐ/cặp là giá sản phẩm tham khảo, chưa VAT. Bài chưa công bố tổng hóa đơn hoàn thiện của ca Camry này."
		},
		{
			q: "Lắp xong có báo lỗi điện không?",
			a: "Tại thời điểm nghiệm thu, không ghi nhận cảnh báo điện liên quan đến bộ đèn. Hồ sơ chưa có hậu kiểm 7–30 ngày nên không suy rộng cho toàn bộ thời gian sử dụng."
		}
	]
};
function buildArticleGraph(data) {
	const imageRecords = [
		{
			role: "hero",
			url: data.media.hero.url,
			caption: data.media.hero.caption
		},
		{
			role: "vehicle",
			url: data.media.vehicle.url,
			caption: data.media.vehicle.caption
		},
		{
			role: "product",
			url: data.media.product.url,
			caption: data.media.product.caption
		},
		...data.media.details.map((item, index) => ({
			role: `detail-${index + 1}`,
			url: item.url,
			caption: item.caption
		})),
		...data.media.beams.map((item) => ({
			role: `beam-${item.label.toLowerCase()}`,
			url: item.url,
			caption: item.caption
		}))
	].filter((item, index, array) => array.findIndex((candidate) => candidate.url === item.url) === index);
	const personId = (name) => `https://auto365.vn/#person-${name.normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace(/đ/g, "d").replace(/Đ/g, "D").toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "")}`;
		...
		"@graph": [
			{
				...
				isPartOf: {
					"@type": "CollectionPage",
					"@id": `${data.cluster.hubUrl}#hub`,
					name: data.cluster.hubName
				}
			},
			{
				"@type": "WebPage",
			...
			},
			{
				...
				itemListElement: [
					...
					},
					{
						"@type": "ListItem",
						position: 2,
						name: data.identity.section,
						item: data.identity.sectionUrl
					},
					{
						"@type": "ListItem",
						position: 3,
						name: data.identity.title,
...
//#endregion
//#region app/page.tsx
var page_exports$10 = /* @__PURE__ */ __exportAll({
	default: () => Home,
	metadata: () => metadata$1
});
var metadata$1 = {
...
function SectionHeading({ number, kicker, title, badge }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
		...
		] }), badge ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
			className: "case-verified-pill",
			children: badge
		}) : null]
	});
}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("script", {
				...
				dangerouslySetInnerHTML: { __html: serializeJsonLd(buildArticleGraph(camryCase)) }
			}),
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "AUTO365" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "XE THẬT · TAY NGHỀ THẬT" })]
						})]
					}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
								className: "case-image-proof",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}),
									" Ảnh từ đúng ca xe · ",
									camryCase.identity.location
								]
							})
						]
					}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
										href: camryCase.identity.sectionUrl,
										children: camryCase.identity.section
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "/" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "Case xe thật" })
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
									...
									children: "CASE LAB · V1.4"
								}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", {
									className: "case-tag",
									children: ["CASE ID · ", camryCase.identity.id]
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h1", {
								id: "page-title",
								children: ["Toyota Camry 2014 2.5Q lắp bi gầm:", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "X-Light F10 Turbo V2 4300K" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
								className: "case-dek",
								children: "Xe thật, cấu hình thật, hình ảnh thật và kết quả nghiệm thu được tách rõ khỏi thông số công bố của sản phẩm."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: camryCase.identity.author.name }),
										" · ",
										camryCase.identity.author.role
									] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: ["Rà soát: ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: camryCase.identity.reviewer.name })] })] }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
										className: "case-date-block",
										children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("time", {
											dateTime: camryCase.identity.published,
											children: ["Đăng ", camryCase.identity.publishedDisplay]
										}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("time", {
											dateTime: camryCase.identity.updated,
											children: ["Cập nhật ", camryCase.identity.updatedDisplay]
										})]
									})
								]
							})
				...
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
					...
					"aria-label": "Thông số tóm tắt",
					children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "case-shell case-fact-grid",
						children: camryCase.decisionFacts.map((fact) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: fact.note })
						] }, fact.label))
					})
				}),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("aside", {
						className: "case-rail",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "TRONG BÀI NÀY" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("ol", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
									href: "#tra-loi-nhanh",
									children: "Trả lời nhanh"
								}) }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
									href: "#cau-hinh",
									children: "Cấu hình đúng ca"
								}) }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
									href: "#hinh-anh",
									children: "Album xe thật"
								}) }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
									href: "#nghiem-thu",
									children: "Bằng chứng nghiệm thu"
								}) }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
									href: "#chi-phi",
									children: "Giá và chi phí"
								}) }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
									href: "#gioi-han",
									children: "Giới hạn dữ liệu"
								}) })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
								className: "case-rail-card",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "HUB TRỤ CỘT" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "Chọn bi gầm theo nhu cầu và cấu hình xe" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
										href: camryCase.cluster.hubUrl,
										children: ["Xem hub bi gầm ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ArrowIcon, {})]
									})
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "GIÁ SẢN PHẨM" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "6.000.000đ/cặp" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "Chưa VAT · chưa phải tổng hoàn thiện" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
										href: "tel:0365365911",
										children: "Gọi tư vấn cấu hình"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
										href: "#dat-lich",
										children: "Kiểm tra xe trước khi lắp"
									})
								]
							})
						]
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
										className: "case-kicker",
										children: "TRẢ LỜI NHANH · DỮ LIỆU ĐÚNG CA"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Camry 2014 trong bài đã lắp cấu hình nào?" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: camryCase.answer }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
										className: "case-answer-grid",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "ĐIỆN" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "Relay + cầu chì bảo vệ nguồn" })] }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "CAN THIỆP" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "Không ghi nhận cắt chi tiết zin" })] }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "NGHIỆM THU" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "Không ghi nhận cảnh báo điện" })] })
										]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
										className: "case-inline-links",
										children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
											href: camryCase.cluster.hubUrl,
											children: ["Hướng dẫn chọn bi gầm theo nhu cầu ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ArrowIcon, {})]
										}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
											href: camryCase.cluster.productUrl,
											children: ["Xem sản phẩm F10 Turbo V2 ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ArrowIcon, {})]
										})]
									})
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
											className: "case-kicker",
											children: "HỘ CHIẾU CA XE"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", {
											id: "passport-title",
											children: "Một hồ sơ, ba mức xác minh"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Trạng thái hiển thị công khai để người đọc và máy tìm kiếm không đánh đồng dữ liệu." })
									]
								}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
									className: "case-passport-grid",
									children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("dl", { children: [
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Xe" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("dd", { children: [
											camryCase.vehicle.make,
											" ",
											camryCase.vehicle.model,
											" ",
											camryCase.vehicle.year
										] })] }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Phiên bản" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: camryCase.vehicle.trim })] }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Ngày dữ liệu" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: camryCase.identity.dataDateDisplay })] }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Điểm thi công" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: camryCase.identity.location })] }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Sản phẩm" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
											href: camryCase.cluster.productUrl,
											children: camryCase.cluster.productName
										}) })] }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Nhóm nội dung" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
											href: camryCase.identity.sectionUrl,
											children: camryCase.identity.section
										}) })] })
									] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
										className: "case-evidence-states",
										children: camryCase.evidenceStates.map((state) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
											className: `case-state case-state--${state.tone}`,
											children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: state.label }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: state.note })] })]
										}, state.label))
									})]
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
								...
								id: "cau-hinh",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SectionHeading, {
									number: "01",
									kicker: "HỒ SƠ THI CÔNG",
									title: "Cấu hình đúng ca Toyota Camry 2014 2.5Q",
									badge: "XÁC NHẬN TRÊN CA XE"
								}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
									className: "case-snapshot-grid",
									children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("figure", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(image_default, {
										src: camryCase.media.vehicle.url,
										alt: camryCase.media.vehicle.alt,
										width: 1620,
										height: 1080,
										sizes: "(max-width: 700px) 100vw, 520px"
									}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("figcaption", { children: camryCase.media.vehicle.caption })] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dl", { children: camryCase.fitment.map((row) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: row.label }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: row.value }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", {
											className: `case-proof case-proof--${row.proof}`,
											children: row.proofLabel
										})
									] }, row.label)) })]
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
								...
								id: "hinh-anh",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SectionHeading, {
										number: "02",
									...
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
										...
										children: "Mỗi ảnh có vai trò và chú thích riêng; không dùng ảnh trang trí không thuộc hồ sơ ca xe."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
										className: "case-photo-story",
										children: camryCase.media.details.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("figure", {
											className: index === 0 ? "case-photo-story__large" : "",
											children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(image_default, {
												src: item.url,
												alt: item.alt,
												width: 1620,
												height: 1080,
												sizes: index === 0 ? "(max-width: 700px) 100vw, 540px" : "(max-width: 700px) 100vw, 270px"
											}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("figcaption", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: item.label }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: item.caption })] })]
										}, item.url))
									})
								]
							}),
									...
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
												"Theo hồ sơ ca lắp, chủ xe thường đi tỉnh và muốn màu sáng trung tính để bổ sung vùng sáng thấp phía trước trong điều kiện thiếu sáng. Vì vậy, cấu hình được chọn là ",
												/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "F10 Turbo V2 4300K" }),
												"."
											] }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Đây là lý do của đúng chủ xe trong bài, không phải cấu hình mặc định cho mọi Toyota Camry 2014." }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
												className: "case-editorial-note",
												children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "NGUYÊN TẮC BIÊN TẬP" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Case chỉ giải thích lựa chọn thực tế; kiến thức so sánh chuyên sâu thuộc hub." })]
											})
										] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("figure", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(image_default, {
											src: camryCase.media.product.url,
											alt: camryCase.media.product.alt,
											width: 1620,
											height: 1080,
											sizes: "(max-width: 700px) 100vw, 420px"
										}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("figcaption", { children: camryCase.media.product.caption })] })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
												className: "case-kicker",
												children: "PHƯƠNG ÁN THI CÔNG ĐÚNG CA"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: "Có gia công trên gá rời, không đồng nghĩa cắt sửa xe" }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Kỹ thuật viên tháo cản, dùng pát đi kèm và hoàn thiện trên bộ gá rời. Hồ sơ không ghi nhận cắt sửa chi tiết nguyên bản." })
										] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("dl", { children: [
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Cố định" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: "Pát kèm + bộ gá rời" })] }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Bảo vệ nguồn" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: "Relay + cầu chì" })] }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Điều khiển" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: "Có công tắc" })] }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Chưa đủ chi tiết" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: "Logic kích hoạt và định mức cầu chì" })] })
										] })]
									})
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
										...
										children: camryCase.productMetrics.map((metric) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: metric.label }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: metric.value }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: metric.note })
										] }, metric.label))
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
										className: "case-source-note",
										children: "Công suất và IP68 là dữ liệu công bố của sản phẩm; không tự động đại diện cho dây, giắc, relay, điểm nối hoặc hiệu quả thực tế trên mọi xe."
									})
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
										...
										children: "MINH BẠCH CHI PHÍ"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "6 triệu là giá sản phẩm, không phải giá hoàn thiện" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Báo giá cuối chỉ chốt sau khi kiểm tra hiện trạng xe và phụ kiện cần dùng." }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("strong", {
										className: "case-big-price",
										children: ["6.000.000 ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "đ / cặp" })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "01 cặp = 02 đèn · chưa bao gồm VAT" })
								] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("dl", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
										className: "known",
										children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "01 cặp F10 Turbo V2" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: "6.000.000đ" })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Thuế VAT" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: "Chưa bao gồm" })] }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Công tháo / lắp" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: "Chưa công bố" })] }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Pát, phụ kiện phát sinh" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: "Chưa công bố" })] }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Tổng hóa đơn ca Camry" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: "Chưa công bố" })] })
								] })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
								className: "case-content-section",
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
										className: "case-section-lead",
										children: "Ảnh minh họa kết quả đúng ca nhưng chưa phải phép đo lux, candela hoặc tầm chiếu chuẩn hóa."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
										className: "case-beam-grid",
										children: camryCase.media.beams.map((image) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("figure", { children: [
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: image.label }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: image.label === "COS" ? "Vùng sáng gần" : "Vùng sáng xa" })] }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(image_default, {
												src: image.url,
												alt: image.alt,
												width: 1620,
											...
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("figcaption", { children: image.caption })
										] }, image.label))
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("i", {}), " NGHIỆM THU TẠI THỜI ĐIỂM BÀN GIAO"] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("b", { children: [
													camryCase.inspection.length,
													"/",
													camryCase.inspection.length,
											...
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
												...
												children: camryCase.inspection.map((item) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "✓" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: item.label }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: item.result })] })] }, item.label))
											}),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "“Không ghi nhận” chỉ phản ánh thời điểm bàn giao, không phải cam kết cho toàn bộ vòng đời sử dụng." })
										]
									})
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SectionHeading, {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h3", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "✓" }), " Đã xác nhận"] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", { children: camryCase.known.map((item) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: item }, item)) })]
									}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
										className: "case-ledger case-ledger--unknown",
										children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h3", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "—" }), " Chưa đủ dữ liệu"] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", { children: camryCase.unknown.map((item) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: item }, item)) })]
									})]
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SectionHeading, {
									...
									children: camryCase.timeline.map((step, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: String(index + 1).padStart(2, "0") }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: step.title }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: step.text })] })] }, step.title))
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SectionHeading, {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
											className: "done",
											children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "NGÀY 0" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Nghiệm thu tại xưởng" })]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "NGÀY 7" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Chờ phản hồi vận hành" })] }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "NGÀY 30" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Chờ kiểm tra lại" })] })
									]
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
								...
								}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { children: camryCase.faq.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("details", {
									open: index === 0,
									children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("summary", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: String(index + 1).padStart(2, "0") }), item.q] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: item.a })]
								}, item.q)) })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
											...
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "NGƯỜI VIẾT" }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: camryCase.identity.author.name }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [camryCase.identity.author.role, " · biên tập từ hồ sơ ca xe."] })
										] })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "RÀ SOÁT KỸ THUẬT" }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: camryCase.identity.reviewer.name }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [camryCase.identity.reviewer.role, "."] })
									] }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
										className: "case-editorial-policy",
										children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "NGUỒN & CẬP NHẬT" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", { children: camryCase.sources.map((source) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", { children: [
											source.name,
											" · cập nhật ",
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("time", {
												dateTime: source.dateModified,
												children: source.dateModified
											})
										] }, `${source.name}-${source.dateModified}`)) })]
									})
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
										className: "case-kicker case-kicker--light",
										children: "KIỂM TRA TRƯỚC · CHỐT SAU"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Anh đang sử dụng Toyota Camry 2014 2.5Q?" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Đặt lịch kiểm tra hốc đèn, pát và phương án điện trước khi chốt cấu hình." }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
										href: "tel:0365365911",
										children: "Gọi 0365 365 911"
									}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
										href: "https://zalo.me/0365365911",
										children: "Tư vấn qua Zalo"
									})] })
								] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("dl", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Điểm kiểm tra" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: camryCase.branch.name })] }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Địa chỉ" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: camryCase.branch.address })] }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: "Giờ làm việc" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: "08:30–17:30" })] })
								] })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("nav", {
								className: "case-cluster-links",
								"aria-label": "Đọc tiếp trong cụm nội dung bi gầm",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
										href: camryCase.cluster.hubUrl,
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "HUB TRỤ CỘT" }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "So sánh cấu hình, nhiệt màu và chi phí bi gầm" }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ArrowIcon, {})
										]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
										href: camryCase.cluster.productUrl,
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "TRANG SẢN PHẨM" }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "Thông số X-Light F10 Turbo V2" }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ArrowIcon, {})
										]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
										href: "https://auto365.vn/toyota-innova-2018-do-bi-gam-x-light-f10-turbo-v2-5500k",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "CASE LIÊN QUAN" }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "Innova Venturer 2018 × F10 Turbo V2 5500K" }),
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ArrowIcon, {})
										]
									})
								]
...
var route_exports$6 = /* @__PURE__ */ __exportAll({ POST: () => POST });
...
var route_exports$5 = /* @__PURE__ */ __exportAll({ GET: () => GET$5 });
...
async function GET$4(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getDashboard } = await import("./assets/case-lab-operations-CSUfsCVN.js");
...
async function GET$2(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getMyProfile } = await import("./assets/case-lab-operations-CSUfsCVN.js");
...
async function PATCH(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { updateMyProfile } = await import("./assets/case-lab-operations-CSUfsCVN.js");
...
async function GET$1(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { listMyNotifications } = await import("./assets/case-lab-operations-CSUfsCVN.js");
...
async function GET(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getOperationsReport } = await import("./assets/case-lab-operations-CSUfsCVN.js");
...
var page_exports$8 = /* @__PURE__ */ __exportAll({ default: () => StudioPage });
function StudioPage() {
	redirect("/workspace");
}
...
var page_exports$7 = /* @__PURE__ */ __exportAll({ default: () => StudioReviewPage });
function StudioReviewPage() {
	redirect("/workspace/review");
}
//#endregion
//#region app/workspace/page.tsx
var page_exports$6 = /* @__PURE__ */ __exportAll({ default: () => page_default$4 });
...
var page_exports$4 = /* @__PURE__ */ __exportAll({ default: () => GuidesPage });
var guides = [
	[
		"01",
