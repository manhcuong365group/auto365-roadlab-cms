globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/navigation-DQh_cwrq.js","assets/page-K68o_eT8.js","assets/page-D9a4Rkal.js","assets/case-editor-AjsQGjc1.js","assets/page-CwlDp7Vz.js","assets/page-12N20nnB.js","assets/page-4hzHAMst.js","assets/page-DSTd0jnV.js","assets/page-Cqh_sBbz.js","assets/sidebar-D4SwHHiz.js","assets/image-DXw0wdHx.js","assets/layout-segment-context-C6AzdhaF.js","assets/link-B1xW-FvJ.js","assets/router-CWgu9Dht.js"];
...
function getDraftSecret() {
	return "b2365252-066c-462b-9019-cd1f803af9f6";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "0788273b-b59d-4ec7-9f41-e351d707f7b5";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "0788273b-b59d-4ec7-9f41-e351d707f7b5") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "0788273b-b59d-4ec7-9f41-e351d707f7b5",
		rootBoundaryId
	});
}
/**
...
async function GET$9(request, context) {
	try {
		...
		const { listCaseAssignments } = await import("./assets/case-lab-operations-DkhP1Vy4.js");
...
async function PUT$1(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { assignCaseReviewer } = await import("./assets/case-lab-operations-DkhP1Vy4.js");
...
async function GET$8(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { listCaseAudit } = await import("./assets/case-lab-operations-DkhP1Vy4.js");
...
async function GET$7(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { getCaseDraft } = await import("./assets/case-lab-operations-DkhP1Vy4.js");
...
async function PUT(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { saveCaseDraft } = await import("./assets/case-lab-operations-DkhP1Vy4.js");
...
async function GET$6(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { listCaseFeedback } = await import("./assets/case-lab-operations-DkhP1Vy4.js");
...
async function POST$4(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { createCaseFeedback } = await import("./assets/case-lab-operations-DkhP1Vy4.js");
...
async function POST$3(request, context) {
	try {
		...
		const { resolveCaseFeedback } = await import("./assets/case-lab-operations-DkhP1Vy4.js");
...
async function POST$2(request, context) {
	try {
		...
		const { markNotificationRead } = await import("./assets/case-lab-operations-DkhP1Vy4.js");
...
async function GET$4(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getDashboard } = await import("./assets/case-lab-operations-DkhP1Vy4.js");
...
async function GET$2(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getMyProfile } = await import("./assets/case-lab-operations-DkhP1Vy4.js");
...
async function PATCH(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { updateMyProfile } = await import("./assets/case-lab-operations-DkhP1Vy4.js");
...
async function GET$1(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { listMyNotifications } = await import("./assets/case-lab-operations-DkhP1Vy4.js");
...
async function GET(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getOperationsReport } = await import("./assets/case-lab-operations-DkhP1Vy4.js");
