...
function getDraftSecret() {
	return "50054651-1060-4bc8-a13e-aba8e16635db";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "be8484de-a6be-4d1a-a0bd-3bbf2527260d";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "be8484de-a6be-4d1a-a0bd-3bbf2527260d") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "be8484de-a6be-4d1a-a0bd-3bbf2527260d",
		rootBoundaryId
	});
}
/**
...
async function GET$9(request, context) {
	try {
		...
		const { listCaseAssignments } = await import("./assets/case-lab-operations-Da2j_7AT.js");
...
async function PUT$1(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { assignCaseReviewer } = await import("./assets/case-lab-operations-Da2j_7AT.js");
...
async function GET$8(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { listCaseAudit } = await import("./assets/case-lab-operations-Da2j_7AT.js");
...
async function GET$7(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { getCaseDraft } = await import("./assets/case-lab-operations-Da2j_7AT.js");
...
async function PUT(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { saveCaseDraft } = await import("./assets/case-lab-operations-Da2j_7AT.js");
...
async function GET$6(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { listCaseFeedback } = await import("./assets/case-lab-operations-Da2j_7AT.js");
...
async function POST$4(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { createCaseFeedback } = await import("./assets/case-lab-operations-Da2j_7AT.js");
...
async function POST$3(request, context) {
	try {
		...
		const { resolveCaseFeedback } = await import("./assets/case-lab-operations-Da2j_7AT.js");
...
async function POST$2(request, context) {
	try {
		...
		const { markNotificationRead } = await import("./assets/case-lab-operations-Da2j_7AT.js");
...
async function GET$4(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getDashboard } = await import("./assets/case-lab-operations-Da2j_7AT.js");
...
async function GET$2(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getMyProfile } = await import("./assets/case-lab-operations-Da2j_7AT.js");
...
async function PATCH(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { updateMyProfile } = await import("./assets/case-lab-operations-Da2j_7AT.js");
...
async function GET$1(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { listMyNotifications } = await import("./assets/case-lab-operations-Da2j_7AT.js");
...
async function GET(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getOperationsReport } = await import("./assets/case-lab-operations-Da2j_7AT.js");
