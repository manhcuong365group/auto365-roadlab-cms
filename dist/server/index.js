...
function getDraftSecret() {
	return "ef7de9c1-dccb-4b8d-8747-db77637cd540";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "d7cbab40-c3f3-4416-b812-9c0bebbc3eb1";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "d7cbab40-c3f3-4416-b812-9c0bebbc3eb1") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "d7cbab40-c3f3-4416-b812-9c0bebbc3eb1",
		rootBoundaryId
	});
}
/**
