globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/case-content-types-QL6dA80t.js","assets/navigation-BJP3l_bn.js","assets/road-lab-draft-Dqw3chzx.js","assets/case-preview-B0HBU3aH.js","assets/page-CR7-5Ow4.js","assets/page-Dm4xFsYI.js","assets/page-BNzIAKyK.js","assets/case-editor-BsIH54KP.js","assets/case-history-BXLUOMsA.js","assets/page-yIiDJ9tN.js","assets/page-CbgfILSs.js","assets/page-Dkg1gA5g.js","assets/page-bMsUc4FR.js","assets/page-CTcBzuNL.js","assets/sidebar-w3DlX8s4.js","assets/topbar-CDTvAlfl.js","assets/page-sPwx5J4l.js","assets/layout-segment-context-B6D7o5gD.js","assets/link-BJ7p1XW3.js","assets/router-DyguFMrM.js"];
import { H as __exportAll, U as __toESM, V as __commonJSMin, a as caseRevisions, d as users, l as urlRegistry, n as authSessions, o as cases } from "./assets/schema-BtN5eNJu.js";
import { a as eq, i as and, n as getDb, o as gt } from "./assets/db-DQL276-1.js";
import { a as parseFaqs, c as parseMetrics, d as parseTimeline, f as getCaseContentType, g as createSessionToken, h as apiErrorResponse, i as getRoadLabMediaUrls, l as parseQc, m as CaseLabApiError, o as parseFollowup, p as normalizeCaseContentType, r as normalizeCaseDraft, s as parseListLines, u as parseRelated, v as hashToken, y as verifyPassword } from "./assets/case-draft-DtbGA5cX.js";
...
function getDraftSecret() {
	return "3dbbdd6e-d499-4337-9c76-bc800828494f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "583103e1-f950-4d56-9509-dc1a1db7d671";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "583103e1-f950-4d56-9509-dc1a1db7d671") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "583103e1-f950-4d56-9509-dc1a1db7d671",
		rootBoundaryId
	});
}
/**
...
//#endregion
//#region server/case-lab-session.ts
var sessionCookieName = "case_lab_session";
var sessionMaxAgeSeconds = 3600 * 24 * 7;
function readSessionToken(request) {
	const cookieHeader = request.headers.get("cookie") ?? "";
	for (const part of cookieHeader.split(";")) {
		const [name, ...valueParts] = part.trim().split("=");
		if (name === "case_lab_session") return valueParts.join("=") || null;
	}
	return null;
}
async function createSession(userId) {
	...
	const expiresAt = new Date(now.getTime() + sessionMaxAgeSeconds * 1e3).toISOString();
...
async function getSessionEmail(request) {
	...
	const [row] = await getDb().select({ email: users.email }).from(authSessions).innerJoin(users, eq(users.id, authSessions.userId)).where(and(eq(authSessions.tokenHash, await hashToken(token)), gt(authSessions.expiresAt, (/* @__PURE__ */ new Date()).toISOString()), eq(users.status, "active"))).limit(1);
...
function sessionCookie(token, maxAge = sessionMaxAgeSeconds, secure = true) {
...
async function requireCaseLabActor(request) {
	...
	const [{ getDb }, { userRoles, users }] = await Promise.all([import("./assets/db-DQL276-1.js").then((n) => n.t), import("./assets/schema-BtN5eNJu.js").then((n) => n.c)]);
	const db = getDb();
...
function parseUserUpdateInput(input) {
	if (!input || typeof input !== "object") throw new CaseLabApiError("VALIDATION_ERROR", "Dữ liệu cập nhật tài khoản không hợp lệ.", 400);
	const value = input;
	const result = {};
	if (value.displayName !== void 0) {
		const displayName = typeof value.displayName === "string" ? value.displayName.trim() : "";
		if (displayName.length < 2 || displayName.length > 100) throw new CaseLabApiError("VALIDATION_ERROR", "Tên hiển thị cần từ 2 đến 100 ký tự.", 400);
		result.displayName = displayName;
	}
	if (value.status !== void 0) {
		if (value.status !== "active" && value.status !== "suspended") throw new CaseLabApiError("VALIDATION_ERROR", "Trạng thái tài khoản không hợp lệ.", 400);
		result.status = value.status;
	}
	if (value.password !== void 0) {
		const password = typeof value.password === "string" ? value.password : "";
		if (password.length < 8 || password.length > 200) throw new CaseLabApiError("VALIDATION_ERROR", "Mật khẩu mới cần tối thiểu 8 ký tự.", 400);
		result.password = password;
	}
	if (value.roles !== void 0) {
		if (!Array.isArray(value.roles) || !value.roles.length) throw new CaseLabApiError("VALIDATION_ERROR", "Cần gán ít nhất một vai trò.", 400);
...
function parsePasswordChangeInput(input) {
	if (!input || typeof input !== "object") throw new CaseLabApiError("VALIDATION_ERROR", "Dữ liệu đổi mật khẩu không hợp lệ.", 400);
	const value = input;
	...
	if (!currentPassword) throw new CaseLabApiError("VALIDATION_ERROR", "Cần nhập mật khẩu hiện tại.", 400);
	if (newPassword.length < 8 || newPassword.length > 200) throw new CaseLabApiError("VALIDATION_ERROR", "Mật khẩu mới cần tối thiểu 8 ký tự.", 400);
	return {
		currentPassword,
		newPassword
	};
}
var caseCreateContentTypes = new Set([
	"case",
	"proof",
	"brand",
	"product"
]);
var userRoleValues = new Set([
	"content",
	"oa",
	"seo_lead",
	"it",
...
function parseUserCreateInput(input) {
	if (!input || typeof input !== "object") throw new CaseLabApiError("VALIDATION_ERROR", "Dữ liệu tài khoản không hợp lệ.", 400);
	const value = input;
	const email = typeof value.email === "string" ? value.email.trim().toLowerCase() : "";
	const displayName = typeof value.displayName === "string" ? value.displayName.trim() : "";
	const password = typeof value.password === "string" ? value.password : "";
	const rolesRaw = Array.isArray(value.roles) ? value.roles : [];
	if (!emailPattern.test(email)) throw new CaseLabApiError("VALIDATION_ERROR", "Email không hợp lệ.", 400);
	if (displayName.length < 2 || displayName.length > 100) throw new CaseLabApiError("VALIDATION_ERROR", "Tên hiển thị cần từ 2 đến 100 ký tự.", 400);
	if (password.length < 8 || password.length > 200) throw new CaseLabApiError("VALIDATION_ERROR", "Mật khẩu cần tối thiểu 8 ký tự.", 400);
	const roles = rolesRaw.map((entry) => {
		if (!entry || typeof entry !== "object") throw new CaseLabApiError("VALIDATION_ERROR", "Vai trò không hợp lệ.", 400);
		const roleEntry = entry;
		const role = roleEntry.role;
		const branchRef = typeof roleEntry.branchRef === "string" ? roleEntry.branchRef.trim() : "";
		if (typeof role !== "string" || !userRoleValues.has(role)) throw new CaseLabApiError("VALIDATION_ERROR", "Vai trò không hợp lệ.", 400);
		if (!branchRef || branchRef.length > 40) throw new CaseLabApiError("VALIDATION_ERROR", "Phạm vi chi nhánh không hợp lệ.", 400);
		return {
			role,
			branchRef
	...
	if (!roles.length) throw new CaseLabApiError("VALIDATION_ERROR", "Cần gán ít nhất một vai trò.", 400);
	return {
		email,
		displayName,
		password,
...
function parseCaseCreateInput(input) {
	if (!input || typeof input !== "object") throw new CaseLabApiError("VALIDATION_ERROR", "Dữ liệu tạo case không hợp lệ.", 400);
	const value = input;
	...
	if (typeof contentType !== "string" || !caseCreateContentTypes.has(contentType)) throw new CaseLabApiError("VALIDATION_ERROR", "Loại nội dung không hợp lệ.", 400);
	if (!branchRef || branchRef.length > 40) throw new CaseLabApiError("VALIDATION_ERROR", "Chi nhánh cần có từ 1 đến 40 ký tự.", 400);
	if (!vehicleRef || vehicleRef.length > 120) throw new CaseLabApiError("VALIDATION_ERROR", "Tên xe cần có từ 1 đến 120 ký tự.", 400);
	if (!productRef || productRef.length > 120) throw new CaseLabApiError("VALIDATION_ERROR", "Tên sản phẩm cần có từ 1 đến 120 ký tự.", 400);
	return {
		contentType,
		branchRef,
		vehicleRef,
...
var route_exports$22 = /* @__PURE__ */ __exportAll({
	GET: () => GET$13,
	PUT: () => PUT$2
});
async function GET$13(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { listCaseAssignments } = await import("./assets/case-lab-operations-CZpoT3aP.js");
		return Response.json(await listCaseAssignments(caseId, actor));
	} catch (error) {
		return apiErrorResponse(request, error);
	}
}
async function PUT$2(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { assignCaseReviewer } = await import("./assets/case-lab-operations-CZpoT3aP.js");
...
var route_exports$21 = /* @__PURE__ */ __exportAll({ GET: () => GET$12 });
async function GET$12(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { listCaseAudit } = await import("./assets/case-lab-operations-CZpoT3aP.js");
...
//#endregion
//#region app/api/v1/case-lab/cases/[caseId]/draft/route.ts
var route_exports$20 = /* @__PURE__ */ __exportAll({
	GET: () => GET$11,
	PUT: () => PUT$1
});
/**
...
*/
function readDraftInput(value) {
	if (!value || typeof value !== "object") throw new CaseLabApiError("VALIDATION_ERROR", "Dữ liệu bản nháp không hợp lệ.", 400);
	const input = value;
	const expectedRevision = input.expectedRevision;
	if (!input.content || typeof input.content !== "object") throw new CaseLabApiError("VALIDATION_ERROR", "Dữ liệu bản nháp không hợp lệ.", 400);
	if (!Number.isInteger(expectedRevision) || expectedRevision < 1) throw new CaseLabApiError("VALIDATION_ERROR", "Revision đang chỉnh sửa không hợp lệ.", 400);
	return {
		content: input.content,
		expectedRevision
	};
}
async function GET$11(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { getCaseDraft } = await import("./assets/case-lab-operations-CZpoT3aP.js");
		return Response.json(await getCaseDraft(caseId, actor));
	} catch (error) {
		return apiErrorResponse(request, error);
	}
}
async function PUT$1(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { saveCaseDraft } = await import("./assets/case-lab-operations-CZpoT3aP.js");
...
async function GET$10(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { listCaseFeedback } = await import("./assets/case-lab-operations-CZpoT3aP.js");
		return Response.json(await listCaseFeedback(caseId, actor));
	} catch (error) {
		return apiErrorResponse(request, error);
	}
}
async function POST$8(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { createCaseFeedback } = await import("./assets/case-lab-operations-CZpoT3aP.js");
...
//#endregion
//#region app/api/v1/case-lab/cases/[caseId]/revisions/route.ts
var route_exports$18 = /* @__PURE__ */ __exportAll({ GET: () => GET$9 });
async function GET$9(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { listCaseRevisions } = await import("./assets/case-lab-operations-CZpoT3aP.js");
...
//#endregion
//#region app/api/v1/case-lab/cases/[caseId]/status/route.ts
var route_exports$17 = /* @__PURE__ */ __exportAll({ PUT: () => PUT });
...
function readStatusInput(value) {
	if (!value || typeof value !== "object") throw new CaseLabApiError("VALIDATION_ERROR", "Dữ liệu không hợp lệ.", 400);
	const input = value;
	if (typeof input.action !== "string" || !VALID_ACTIONS.has(input.action)) throw new CaseLabApiError("VALIDATION_ERROR", "Hành động không hợp lệ.", 400);
	if (!Number.isInteger(input.expectedRevision) || input.expectedRevision < 0) throw new CaseLabApiError("VALIDATION_ERROR", "Revision đang thao tác không hợp lệ.", 400);
	const note = typeof input.note === "string" ? input.note.slice(0, 1e3) : void 0;
	return {
		action: input.action,
...
async function PUT(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { transitionCaseStatus } = await import("./assets/case-lab-operations-CZpoT3aP.js");
...
var route_exports$16 = /* @__PURE__ */ __exportAll({ POST: () => POST$7 });
async function POST$7(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { feedbackId } = await context.params;
		const { resolveCaseFeedback } = await import("./assets/case-lab-operations-CZpoT3aP.js");
...
var route_exports$15 = /* @__PURE__ */ __exportAll({ POST: () => POST$6 });
async function POST$6(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { notificationId } = await context.params;
		const { markNotificationRead } = await import("./assets/case-lab-operations-CZpoT3aP.js");
...
var page_exports$18 = /* @__PURE__ */ __exportAll({ default: () => page_default$8 });
...
var sidebar_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "c7279ccfed14", "default");
//#endregion
//#region app/workspace/topbar.tsx
var topbar_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "b549c8687336", "default");
//#endregion
...
function WorkspaceLayout({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(sidebar_default, {}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
			className: "workspace-page",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(topbar_default, {}), children]
		})]
	});
}
...
var case_history_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "cc9c08d185b2", "default");
//#endregion
//#region app/workspace/cases/[caseId]/history/page.tsx
var page_exports$17 = /* @__PURE__ */ __exportAll({ default: () => CaseHistoryPage });
async function CaseHistoryPage({ params }) {
	const { caseId } = await params;
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(case_history_default, { caseId });
}
//#endregion
//#region app/workspace/cases/[caseId]/case-editor.tsx
var case_editor_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "1bfb2b82b559", "default");
//#endregion
//#region app/workspace/cases/[caseId]/review/page.tsx
var page_exports$16 = /* @__PURE__ */ __exportAll({ default: () => CaseReviewPage });
async function CaseReviewPage({ params }) {
	const { caseId } = await params;
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(case_editor_default, {
		caseId,
		mode: "review"
	});
}
//#endregion
//#region app/api/v1/case-lab/cases/[caseId]/revisions/[revision]/route.ts
var route_exports$14 = /* @__PURE__ */ __exportAll({ GET: () => GET$8 });
async function GET$8(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId, revision } = await context.params;
		const revisionNumber = Number(revision);
		if (!Number.isInteger(revisionNumber) || revisionNumber < 1) throw new CaseLabApiError("VALIDATION_ERROR", "Số revision không hợp lệ.", 400);
		const { getCaseRevisionContent } = await import("./assets/case-lab-operations-CZpoT3aP.js");
...
//#endregion
//#region app/api/v1/case-lab/users/[userId]/route.ts
var route_exports$13 = /* @__PURE__ */ __exportAll({ PATCH: () => PATCH$1 });
async function PATCH$1(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { userId } = await context.params;
		const { updateUser } = await import("./assets/case-lab-operations-CZpoT3aP.js");
...
//#endregion
//#region app/page.tsx
var page_exports$15 = /* @__PURE__ */ __exportAll({ default: () => HomePage });
function HomePage() {
	redirect("/workspace");
}
//#endregion
//#region app/api/auth/login/route.ts
var route_exports$12 = /* @__PURE__ */ __exportAll({ POST: () => POST$5 });
async function POST$5(request) {
	let input;
	try {
		input = await request.json();
	} catch {
		return Response.json({ error: { message: "Dữ liệu đăng nhập không hợp lệ." } }, { status: 400 });
	}
	...
	if (!user || user.status === "suspended" || !user.passwordHash || !await verifyPassword(password, user.passwordHash)) return Response.json({ error: { message: "Email hoặc mật khẩu không đúng." } }, { status: 401 });
	...
	} }, { headers: { "Set-Cookie": sessionCookie(token, void 0, secure) } });
}
//#endregion
//#region app/api/auth/logout/route.ts
var route_exports$11 = /* @__PURE__ */ __exportAll({ POST: () => POST$4 });
async function POST$4(request) {
	await deleteSession(request);
	const secure = new URL(request.url).protocol === "https:";
	return new Response(null, {
		status: 204,
		headers: { "Set-Cookie": sessionCookie("", 0, secure) }
	});
}
//#endregion
//#region app/api/auth/me/route.ts
var route_exports$10 = /* @__PURE__ */ __exportAll({ GET: () => GET$7 });
async function GET$7(request) {
	try {
		return Response.json(await requireCaseLabActor(request));
	} catch (error) {
		return apiErrorResponse(request, error);
	}
}
//#endregion
//#region app/api/v1/case-lab/cases/route.ts
var route_exports$9 = /* @__PURE__ */ __exportAll({ POST: () => POST$3 });
async function POST$3(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { createCase } = await import("./assets/case-lab-operations-CZpoT3aP.js");
...
async function GET$6(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getDashboard } = await import("./assets/case-lab-operations-CZpoT3aP.js");
...
var route_exports$7 = /* @__PURE__ */ __exportAll({ GET: () => GET$5 });
function GET$5() {
...
async function GET$4(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getMyProfile } = await import("./assets/case-lab-operations-CZpoT3aP.js");
...
async function PATCH(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { updateMyProfile } = await import("./assets/case-lab-operations-CZpoT3aP.js");
...
//#endregion
//#region app/api/v1/case-lab/me/password/route.ts
var route_exports$5 = /* @__PURE__ */ __exportAll({ POST: () => POST$2 });
async function POST$2(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { changeMyPassword } = await import("./assets/case-lab-operations-CZpoT3aP.js");
...
var route_exports$4 = /* @__PURE__ */ __exportAll({ GET: () => GET$3 });
async function GET$3(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { listMyNotifications } = await import("./assets/case-lab-operations-CZpoT3aP.js");
...
var route_exports$3 = /* @__PURE__ */ __exportAll({ GET: () => GET$2 });
async function GET$2(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getOperationsReport } = await import("./assets/case-lab-operations-CZpoT3aP.js");
...
//#endregion
//#region app/api/v1/case-lab/uploads/route.ts
...
async function POST$1(request) {
	try {
		...
		if (!form || !(file instanceof File)) throw new CaseLabApiError("VALIDATION_ERROR", "Thiếu tệp ảnh để tải lên.", 400);
		if (!ALLOWED_TYPES.has(file.type)) throw new CaseLabApiError("VALIDATION_ERROR", "Chỉ hỗ trợ ảnh JPEG, PNG, WebP, GIF hoặc AVIF.", 400);
		if (file.size > MAX_UPLOAD_BYTES) throw new CaseLabApiError("VALIDATION_ERROR", "Ảnh vượt quá dung lượng tối đa 15MB.", 400);
		const key = crypto.randomUUID();
		const bytes = await file.arrayBuffer();
		await env.MEDIA_KV.put(key, bytes, { metadata: {
...
//#endregion
//#region app/api/v1/case-lab/users/route.ts
...
async function GET$1(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { listUsers } = await import("./assets/case-lab-operations-CZpoT3aP.js");
...
async function POST(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { createUser } = await import("./assets/case-lab-operations-CZpoT3aP.js");
...
var page_exports$13 = /* @__PURE__ */ __exportAll({ default: () => StudioPage });
function StudioPage() {
	redirect("/workspace");
}
...
})(import_react_react_server.default, assetsManifest.serverResources["app/studio/layout.tsx"], void 0, "vite-rsc/importer-resources");
//#endregion
//#region app/studio/layout.tsx
var layout_exports = /* @__PURE__ */ __exportAll({
	default: () => $$wrap_StudioLayout,
	metadata: () => metadata
});
var metadata = {
	title: "Auto365 Case Lab Studio V2.0 – Production Zero-Rekey",
...
var $$wrap_StudioLayout = /* @__PURE__ */ __vite_rsc_wrap_css__(StudioLayout, "default");
...
var page_exports$12 = /* @__PURE__ */ __exportAll({ default: () => StudioReviewPage });
function StudioReviewPage() {
	redirect("/workspace/review");
}
//#endregion
//#region app/workspace/page.tsx
var page_exports$11 = /* @__PURE__ */ __exportAll({ default: () => page_default$6 });
var page_default$6 = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "a8c58a62f4a4", "default");
//#endregion
//#region app/workspace/account/page.tsx
var page_exports$10 = /* @__PURE__ */ __exportAll({ default: () => page_default$5 });
var page_default$5 = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "b4be5f6b4b82", "default");
//#endregion
//#region app/workspace/cases/page.tsx
var page_exports$9 = /* @__PURE__ */ __exportAll({ default: () => page_default$4 });
...
//#endregion
//#region app/workspace/guides/page.tsx
var page_exports$8 = /* @__PURE__ */ __exportAll({ default: () => GuidesPage });
var guides = [
	[
		"01",
		"Chuẩn bị case trước khi viết",
		"Kiểm tra nguồn, ảnh nghiệm thu và revision đang làm việc trước khi gửi review.",
		"/workspace/cases"
	],
	[
		"02",
		"Review feedback theo revision",
		"Mỗi phản hồi gắn với revision để Content, OA/SEO Lead và IT cùng theo dõi một ngữ cảnh.",
		"/workspace/review"
	],
	[
		"03",
		"Theo dõi SLA và khối lượng",
		"Dùng báo cáo vận hành để phát hiện case quá hạn hoặc hàng chờ tăng bất thường.",
		"/workspace/reports"
	],
	[
		"04",
		"Xử lý thông báo",
		"Đọc và đánh dấu thông báo sau khi đã xử lý để không bỏ sót phản hồi mới.",
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
						...
						children: "Case Lab · tài liệu nội bộ"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: "Kho hướng dẫn" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Các quy tắc ngắn để vận hành luồng bài viết, review và báo cáo trong Case Lab." })
				] })
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				className: "workspace-guide-grid",
				children: guides.map(([number, title, description, href]) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(link_default, {
					className: "workspace-guide",
					href,
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: number }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: title }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: description })] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", {
							"aria-hidden": "true",
							children: "→"
						})
					]
...
//#endregion
//#region app/workspace/handoff/page.tsx
var page_exports$7 = /* @__PURE__ */ __exportAll({ default: () => HandoffPage });
var flow = [
	[
		"01",
		"Tạo case",
...
var features = [
	[
		"4 layout bài viết riêng biệt",
		"Road Lab, Proof Lab, Brand Story, Product Spotlight — mỗi loại một bố cục khác nhau thật sự, khung ngoài khớp brand auto365.vn.",
		"/tin-tuc/review-auto365-demo-11"
	],
...
var accounts = [
	[
		"Sếp",
		"boss@auto365.test",
		"Toàn quyền — tạo tài khoản, duyệt mọi bước, xuất bản"
	],
	[
		"Content",
		"content@auto365.test",
		"Tạo case, soạn bài, upload ảnh, gửi duyệt"
	],
	[
		"IT",
		"it@auto365.test",
...
var gaps = [
	[
		...
		"Hiện chỉ thông báo trong app. Muốn báo qua Zalo hoặc email cần Sếp cung cấp API Zalo OA hoặc dịch vụ gửi email — chưa có sẵn để tự làm."
	],
	[
		"Cân nhắc",
		"Nén ảnh phía server",
		"Ảnh lưu nguyên dung lượng (tối đa 15MB/ảnh). Tự động nén cần dịch vụ trả phí của Cloudflare hoặc thêm thư viện riêng."
	],
	[
		"Không cần",
		"Sitemap / trang mục lục công khai",
		"Bỏ qua theo yêu cầu — bài xuất bản cuối cùng nằm trên auto365.vn thật, SEO xử lý ở đó."
	]
];
var decisions = [
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
						className: "workspace-eyebrow",
						children: "Case Lab · báo cáo bàn giao"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: "Case Lab CMS đã sẵn sàng để Sếp duyệt" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Toàn bộ tính năng bên dưới đã được gọi thật lên server production để kiểm chứng, không chỉ đọc code." })
				] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
					className: "workspace-status-pill workspace-status-pill--published",
					children: "Sẵn sàng đưa content thật vào dùng"
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "workspace-card handoff-section",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Vòng vận hành — 7 bước" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "workspace-flow",
					children: flow.map(([number, label, who]) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "workspace-flow-step",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
								className: "workspace-flow-step__num",
								children: number
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: label }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: who })
						]
					}, number))
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "workspace-card handoff-section",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Đã build & test thật" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "handoff-feature-grid",
					children: features.map(([title, description, href]) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "handoff-feature",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
								className: "handoff-feature__head",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: title }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
									className: "handoff-tested",
									children: "✓ đã test"
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: description }),
							href ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(link_default, {
								href,
								target: "_blank",
								rel: "noreferrer",
								children: "Xem ví dụ →"
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "workspace-card handoff-section",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Thử ngay" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
						className: "workspace-editor-note",
						children: ["Tài khoản demo để tự trải nghiệm — mật khẩu chung: ", /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: "CaseLab-2026!" })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "workspace-table workspace-table--full workspace-table--handoff",
						role: "table",
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							...
							role: "row",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Vai trò" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Email" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Làm được gì" })
							]
						}), accounts.map(([role, email, does]) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							className: "workspace-row",
							role: "row",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: role }) }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: email }) }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: does })
							]
						}, email))]
					})
				]
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "workspace-card handoff-section",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Thành thật — giới hạn hiện tại" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "handoff-gap-list",
					children: gaps.map(([badge, title, description]) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "handoff-gap-item",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
							className: `handoff-gap-badge handoff-gap-badge--${badge === "Không cần" ? "ok" : "need"}`,
							children: badge
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: title }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: description })] })]
					}, title))
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "workspace-card handoff-section handoff-decision",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Cần Sếp quyết định" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", {
					className: "handoff-decision-list",
					children: decisions.map((item) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { className: "handoff-decision-box" }), item] }, item))
				})]
			})
		]
	});
...
var page_exports$6 = /* @__PURE__ */ __exportAll({ default: () => page_default$3 });
var page_default$3 = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "d748467dbe73", "default");
//#endregion
...
var page_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "cba40f3ab81d", "default");
//#endregion
//#region app/workspace/cases/[caseId]/page.tsx
var page_exports$2 = /* @__PURE__ */ __exportAll({ default: () => CaseDetailPage });
...
var case_preview_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "85778b6a2934", "default");
//#endregion
//#region app/case-preview/[caseId]/page.tsx
var page_exports$1 = /* @__PURE__ */ __exportAll({ default: () => CasePreviewPage });
async function CasePreviewPage({ params }) {
	const { caseId } = await params;
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(case_preview_default, { caseId });
}
//#endregion
//#region app/media/[key]/route.ts
...
//#endregion
//#region server/case-lab-public.ts
/**
...
async function getPublishedCaseBySlug(slug) {
	...
	const [revision] = await getDb().select().from(caseRevisions).where(and(eq(caseRevisions.caseId, caseItem.id), eq(caseRevisions.revision, revisionNumber))).limit(1);
...
var SITE_URL$1 = "https://auto365.vn";
var PUBLISHER_ID = `${SITE_URL$1}/#organization`;
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(link_default, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
							...
							children: "AUTO365"
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: "HỆ THỐNG NÂNG CẤP XE TOÀN QUỐC" })]
					}),
...
function SidebarWidgets({ vm, branchRef, toc }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("aside", {
		className: "site-sidebar",
		children: [
			toc ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "site-widget site-widget--toc",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: "Trong bài này" }), toc]
			}) : null,
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "site-widget site-widget--contact",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: "Cần tư vấn?" }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: HOTLINE_DISPLAY }),
			...
			vm.relatedLinks.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "site-widget",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: "Bài viết liên quan" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", { children: vm.relatedLinks.map((link, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
					href: link.url,
					children: link.label
				}) }, index)) })]
			}) : null
...
function FinalCta() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Cần tư vấn giải pháp tương tự?" }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Liên hệ Auto365.vn để được tư vấn theo đúng nhu cầu và ca xe của bạn." }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
				href: HOTLINE_HREF,
				children: HOTLINE_DISPLAY
			}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(link_default, {
				href: "/",
...
function TailSections({ vm, skipMetrics }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
		!skipMetrics && vm.metrics.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: "case-content-section",
			id: "metrics",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				className: "case-section-heading",
				children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Thông số sản phẩm" }) })
			}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				className: "case-metric-grid",
				children: vm.metrics.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: item.label }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: item.value }),
					item.note ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: item.note }) : null
				] }, index))
			})]
		}) : null,
		vm.evidenceImages.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: "case-content-section",
			id: "evidence",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
						...
						children: "•"
					}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Bằng chứng" })] })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "case-photo-story",
					children: vm.evidenceImages.map((url, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("figure", {
				...
				vm.sourceNote ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
					className: "case-source-note",
					children: vm.sourceNote
				}) : null
			]
		}) : null,
		vm.beamCosUrl || vm.beamPhaUrl ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: "case-content-section",
			id: "beams",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				className: "case-section-heading",
				children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Vùng sáng Cos/Pha" }) })
			}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "case-beam-grid",
				children: [vm.beamCosUrl ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("figure", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "COS" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "Chế độ chiếu gần" })] }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
						src: vm.beamCosUrl,
						alt: `Vùng sáng Cos — ${vm.title}`
					}),
					vm.beamCosCaption ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("figcaption", { children: vm.beamCosCaption }) : null
				] }) : null, vm.beamPhaUrl ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("figure", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "PHA" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "Chế độ chiếu xa" })] }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
						src: vm.beamPhaUrl,
						alt: `Vùng sáng Pha — ${vm.title}`
					}),
					vm.beamPhaCaption ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("figcaption", { children: vm.beamPhaCaption }) : null
				] }) : null]
			})]
		}) : null,
		vm.timelineSteps.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: "case-content-section",
			id: "timeline",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				className: "case-section-heading",
				children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
					className: "case-section-no",
					children: "•"
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Timeline thực hiện" })] })
			}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ol", {
				className: "case-timeline",
				children: vm.timelineSteps.map((step, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: String(index + 1).padStart(2, "0") }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: step.title }), step.text ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: step.text }) : null] })] }, index))
			})]
		}) : null,
		vm.known.length || vm.unknown.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: "case-ledger-section",
			id: "ledger",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				className: "case-section-heading",
				children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Đã biết / Chưa biết" }) })
			}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "case-ledger-grid",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "case-ledger case-ledger--yes",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h3", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "✓" }), "Đã xác nhận"] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", { children: vm.known.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: item }, index)) })]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "case-ledger case-ledger--unknown",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h3", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "?" }), "Chưa xác nhận"] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", { children: vm.unknown.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: item }, index)) })]
				})]
			})]
		}) : null,
		vm.qcItems.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: "case-content-section",
			id: "qc",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				className: "case-section-heading",
				children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Kiểm tra chất lượng" }) })
			}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "case-qc-card",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "case-qc-head",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("i", {}), "ĐÃ NGHIỆM THU"] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("b", { children: [vm.qcItems.length, " hạng mục đã kiểm tra"] })]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "case-qc-grid",
					children: vm.qcItems.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "✓" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: item.label }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: item.result })] })] }, index))
				})]
			})]
		}) : null,
		vm.priceValue ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: vm.priceValue }),
				vm.priceNote ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: vm.priceNote }) : null
			] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dl", { children: vm.priceIncludes.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "known",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: String(index + 1).padStart(2, "0") }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: item })]
			}, index)) })]
		}) : null,
		vm.faqs.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: "case-faq-section",
			id: "faq",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				className: "case-section-heading",
				children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Hỏi đáp" }) })
			}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { children: vm.faqs.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("details", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("summary", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: String(index + 1).padStart(2, "0") }), item.q] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: item.a })] }, index)) })]
		}) : null,
		vm.reviewerName || vm.primarySource ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "TÁC GIẢ" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: vm.authorName }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: vm.authorRole })
					] })]
				}),
				vm.reviewerName ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "case-author-person",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
						className: "case-avatar case-avatar--large",
						children: initials(vm.reviewerName)
					}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "NGƯỜI RÀ SOÁT" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: vm.reviewerName }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: vm.reviewerRole })
					] })]
				}) : null,
				vm.primarySource ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "case-editorial-policy",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "NGUỒN CHÍNH" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: vm.primarySource })]
				}) : null
			]
		}) : null,
		vm.followupSteps.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: "case-followup-section",
			id: "followup",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				className: "case-section-heading",
				children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Theo dõi hậu kiểm" }) })
			}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				className: "case-followup-track",
				children: vm.followupSteps.map((step, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: step.done ? "done" : void 0,
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: step.date || `MỐC ${index + 1}` }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: step.label })]
				}, index))
			})]
		}) : null,
		vm.relatedLinks.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
			className: "case-content-section",
			id: "related",
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				className: "case-section-heading",
				children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Bài liên quan" }) })
			}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				className: "case-cluster-links",
				children: vm.relatedLinks.map((link, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("a", {
					href: link.url,
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "ĐỌC THÊM" }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: link.label }),
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [vm.heroUrl ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
						src: vm.heroUrl,
						alt: vm.title
					}) : null, /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { className: "case-hero-scrim" })]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "Auto365" }),
								" ",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "/" }),
								" ",
								contentTypeLabel,
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: vm.title }),
						vm.summary ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
							className: "case-dek",
							children: vm.summary
						}) : null,
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: vm.authorName }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
									vm.authorRole
								] }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
									className: "case-date-block",
									children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Xuất bản" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: publishedDisplay })]
								})
							]
						})
					]
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					...
					children: vm.facts.map((fact) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: fact.label }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: fact.value }),
						fact.note ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: fact.note }) : null
					] }, fact.label))
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
					...
					children: [
						vm.answerFirst ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Answer First" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: vm.answerFirst })
							]
						}) : null,
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: vm.profileHeading }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: vm.profileLead })
								]
							}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
								className: "case-passport-grid",
								children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dl", { children: vm.profileEntries.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: entry.label }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: entry.value })] }, entry.label)) })
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
							className: "case-content-section",
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
										className: "case-section-no",
										children: "02"
									}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: vm.editorialHeading })] })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [vm.editorialParagraphs.length ? vm.editorialParagraphs.map((paragraph, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: paragraph }, index)) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Chưa cập nhật nội dung chi tiết." }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
										className: "case-editorial-note",
										children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: vm.editorialNoteLabel }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: vm.editorialNoteText })]
									})] })
								})
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: vm.methodHeading }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: vm.methodLead })
								] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dl", { children: vm.methodEntries.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: entry.label }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: entry.value })] }, entry.label)) })]
							})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(TailSections, { vm })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SidebarWidgets, {
					vm,
					branchRef,
					toc: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("ol", { children: [
						...
						vm.metrics.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
							href: "#metrics",
							children: "Thông số sản phẩm"
						}) }) : null,
						vm.evidenceImages.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
							href: "#evidence",
							children: "Bằng chứng"
						}) }) : null,
						vm.timelineSteps.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
							href: "#timeline",
							children: "Timeline"
						}) }) : null,
						vm.qcItems.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
							href: "#qc",
							children: "Kiểm tra chất lượng"
						}) }) : null,
						vm.faqs.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
							href: "#faq",
							children: "Hỏi đáp"
						}) }) : null
					] })
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(FinalCta, {})
		]
	});
}
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "ĐÃ NGHIỆM THU" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: publishedDisplay })]
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
							className: "proof-meta-row",
							children: vm.facts.map((fact) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: fact.label }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: fact.value })] }, fact.label))
						})
					]
				})
			}),
					...
					children: [
						vm.answerFirst ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Kết quả nghiệm thu" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: vm.answerFirst })
							]
						}) : null,
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
										className: "case-section-no",
										children: "01"
									}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: vm.methodHeading })] })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
									className: "case-section-lead",
									children: vm.methodLead
								}),
								vm.methodEntries.length === 2 ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
									className: "case-compare-grid proof-compare-grid",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
											className: "case-compare-panel case-compare-panel--before",
											children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: vm.methodEntries[0].label }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: vm.methodEntries[0].value })]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
										...
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: vm.methodEntries[1].label }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: vm.methodEntries[1].value })]
										})
									]
								}) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dl", {
									className: "proof-plain-dl",
									children: vm.methodEntries.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: entry.label }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: entry.value })] }, entry.label))
								})
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dl", {
									className: "proof-plain-dl",
									children: vm.profileEntries.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dt", { children: entry.label }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("dd", { children: entry.value })] }, entry.label))
								})
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
							...
							children: [
								...
								vm.editorialParagraphs.length ? vm.editorialParagraphs.map((paragraph, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
									className: "proof-paragraph",
									children: paragraph
								}, index)) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
									className: "proof-paragraph",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				...
				children: [vm.heroUrl ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "brand-hero-media",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
						src: vm.heroUrl,
						alt: vm.title
					}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { className: "case-hero-scrim" })]
				}) : null, /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						...
						vm.answerFirst ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ol", {
									...
									children: vm.editorialParagraphs.length ? vm.editorialParagraphs.map((paragraph, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: String(index + 1).padStart(2, "0") }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: paragraph })] }, index)) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "01" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Chưa cập nhật nội dung chi tiết." })] })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
									className: "case-editorial-note",
									children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: vm.editorialNoteLabel }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: vm.editorialNoteText })]
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
									...
									children: vm.methodEntries.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: entry.label }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: entry.value })] }, entry.label))
								})
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(TailSections, { vm })
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					...
					children: gallery.length ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("figure", {
						className: "product-gallery-main",
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
							src: gallery[0],
							alt: vm.title
						})
					}), gallery.length > 1 ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "product-gallery-thumbs",
						children: gallery.slice(1, 5).map((url, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
							src: url,
							alt: `${vm.title} — ảnh ${index + 2}`,
							loading: "lazy"
						}, url))
					}) : null] }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { className: "product-gallery-empty" })
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", {
							...
							children: vm.facts.map((fact) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: fact.label }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: fact.value })] }, fact.label))
						}),
						vm.priceValue ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							className: "product-price-card",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "GIÁ THAM KHẢO" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: vm.priceValue }),
								vm.priceNote ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("small", { children: vm.priceNote }) : null,
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
									href: HOTLINE_HREF,
					...
					children: [
						vm.answerFirst ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Có nên chọn sản phẩm này?" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: vm.answerFirst })
							]
						}) : null,
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("table", {
									className: "product-spec-table",
									children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tbody", { children: vm.profileEntries.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("tr", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("th", { children: entry.label }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: entry.value })] }, entry.label)) })
								})
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", {
									...
									children: vm.editorialParagraphs.length ? vm.editorialParagraphs.map((paragraph, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "✓" }), paragraph] }, index)) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "✓" }), "Chưa cập nhật nội dung chi tiết."] })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
									className: "case-editorial-note",
									children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: vm.editorialNoteLabel }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: vm.editorialNoteText })]
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("table", {
									className: "product-compare-table",
									children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("tr", { children: [
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("th", {}),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("th", { children: "Sản phẩm này" }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("th", { children: "Lựa chọn khác" })
									] }) }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tbody", { children: vm.methodEntries.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("tr", { children: [
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("th", { children: entry.label }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: entry.value }),
...
function CaseArticleView({ vm, contentTypeLabel, caseCode, branchRef, publishedDisplay, jsonLd }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [vm.templateKey === "proof_lab" ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ProofLabArticle, { ...props }) : vm.templateKey === "brand_story" ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(BrandStoryArticle, { ...props }) : vm.templateKey === "product_spotlight" ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ProductSpotlightArticle, { ...props }) : /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(RoadLabArticle, { ...props }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("script", {
		type: "application/ld+json",
		dangerouslySetInnerHTML: { __html: serializeJsonLd(jsonLd) }
	})] });
}
//#endregion
//#region app/tin-tuc/[slug]/page.tsx
var page_exports = /* @__PURE__ */ __exportAll({
	default: () => PublicCaseArticlePage,
...
async function generateMetadata({ params }) {
	...
	return {
		...
		openGraph: {
			...
			images: vm.heroUrl ? [vm.heroUrl] : void 0
		},
		twitter: {
...
async function PublicCaseArticlePage({ params }) {
	const { slug } = await params;
	const published = await getPublishedCaseBySlug(slug);
	if (!published) notFound();
	const vm = buildArticleViewModel(published.content);
	const jsonLd = buildCaseArticleJsonLd(vm, published.canonicalUrl || `${SITE_URL}/tin-tuc/${slug}`, published.publishedAt);
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(CaseArticleView, {
		vm,
...
var routes = [
	...
	},
	{
		...
		ids: {
			"route": "route:/api/v1/case-lab/cases/:caseId/draft",
			"page": null,
			"routeHandler": "route-handler:/api/v1/case-lab/cases/:caseId/draft",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/v1/case-lab/cases/:caseId/draft",
		patternParts: [
			"api",
			"v1",
			"case-lab",
	...
	},
	{
		...
		ids: {
			"route": "route:/api/v1/case-lab/cases/:caseId/revisions",
			"page": null,
			"routeHandler": "route-handler:/api/v1/case-lab/cases/:caseId/revisions",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/v1/case-lab/cases/:caseId/revisions",
		patternParts: [
			"api",
			"v1",
			"case-lab",
	...
	},
	{
		...
		ids: {
			"route": "route:/api/v1/case-lab/cases/:caseId/status",
			"page": null,
			"routeHandler": "route-handler:/api/v1/case-lab/cases/:caseId/status",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/v1/case-lab/cases/:caseId/status",
		patternParts: [
			"api",
			"v1",
			"case-lab",
	...
	},
	{
		...
		ids: {
			"route": "route:/workspace/cases/:caseId/history",
			"page": "page:/workspace/cases/:caseId/history",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/", "layout:/workspace"],
			"templates": [],
		...
		pattern: "/workspace/cases/:caseId/history",
		patternParts: [
			"workspace",
			"cases",
			":caseId",
	...
	},
	{
		...
		ids: {
			"route": "route:/api/v1/case-lab/cases/:caseId/revisions/:revision",
			"page": null,
			"routeHandler": "route-handler:/api/v1/case-lab/cases/:caseId/revisions/:revision",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/v1/case-lab/cases/:caseId/revisions/:revision",
		patternParts: [
			"api",
			"v1",
			"case-lab",
	...
	},
	{
		...
		ids: {
			"route": "route:/api/v1/case-lab/users/:userId",
			"page": null,
			"routeHandler": "route-handler:/api/v1/case-lab/users/:userId",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/v1/case-lab/users/:userId",
		patternParts: [
			"api",
			"v1",
			"case-lab",
	...
	},
	{
		...
		ids: {
			"route": "route:/api/auth/me",
			"page": null,
			"routeHandler": "route-handler:/api/auth/me",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
	...
	},
	{
		...
		ids: {
			"route": "route:/api/v1/case-lab/cases",
			"page": null,
			"routeHandler": "route-handler:/api/v1/case-lab/cases",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/v1/case-lab/cases",
		patternParts: [
			"api",
			"v1",
			"case-lab",
	...
	},
	{
		...
		ids: {
			"route": "route:/api/v1/case-lab/me/password",
			"page": null,
			"routeHandler": "route-handler:/api/v1/case-lab/me/password",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/v1/case-lab/me/password",
		patternParts: [
			"api",
			"v1",
			"case-lab",
	...
	},
	{
		...
		ids: {
			"route": "route:/api/v1/case-lab/uploads",
			"page": null,
			"routeHandler": "route-handler:/api/v1/case-lab/uploads",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/v1/case-lab/uploads",
		patternParts: [
			"api",
			"v1",
			"case-lab",
	...
	},
	{
		...
		ids: {
			"route": "route:/api/v1/case-lab/users",
			"page": null,
			"routeHandler": "route-handler:/api/v1/case-lab/users",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
		},
		pattern: "/api/v1/case-lab/users",
		patternParts: [
			"api",
			"v1",
			"case-lab",
	...
	},
	{
		...
		pattern: "/studio/review",
		patternParts: ["studio", "review"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
	...
	},
	{
		...
		ids: {
			"route": "route:/workspace/account",
			"page": "page:/workspace/account",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/", "layout:/workspace"],
			"templates": [],
		...
		pattern: "/workspace/account",
		patternParts: ["workspace", "account"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
		...
		routeHandler: null,
		layouts: [layout_exports$2, layout_exports$1],
		routeSegments: ["workspace", "account"],
		templateTreePositions: [],
		layoutTreePositions: [0, 1],
		templates: [],
		errors: [null, null],
	...
	},
	{
		...
		ids: {
			"route": "route:/workspace/guides",
			"page": "page:/workspace/guides",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/", "layout:/workspace"],
			"templates": [],
		...
		pattern: "/workspace/guides",
		patternParts: ["workspace", "guides"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
		page: page_exports$8,
		routeHandler: null,
		layouts: [layout_exports$2, layout_exports$1],
		routeSegments: ["workspace", "guides"],
		templateTreePositions: [],
		layoutTreePositions: [0, 1],
		templates: [],
		errors: [null, null],
	...
	},
	{
		...
		ids: {
			"route": "route:/workspace/handoff",
			"page": "page:/workspace/handoff",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/", "layout:/workspace"],
			"templates": [],
		...
		patternParts: ["workspace", "handoff"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
		page: page_exports$7,
		routeHandler: null,
		layouts: [layout_exports$2, layout_exports$1],
		routeSegments: ["workspace", "handoff"],
		templateTreePositions: [],
		layoutTreePositions: [0, 1],
		templates: [],
		errors: [null, null],
	...
	},
	{
		...
		ids: {
			"route": "route:/workspace/notifications",
			"page": "page:/workspace/notifications",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/", "layout:/workspace"],
			"templates": [],
		...
		patternParts: ["workspace", "notifications"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
		page: page_exports$6,
		routeHandler: null,
		layouts: [layout_exports$2, layout_exports$1],
		routeSegments: ["workspace", "notifications"],
		templateTreePositions: [],
		layoutTreePositions: [0, 1],
		templates: [],
		errors: [null, null],
	...
	},
	{
		...
		ids: {
			"route": "route:/workspace/review",
			"page": "page:/workspace/review",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/", "layout:/workspace"],
			"templates": [],
		...
		pattern: "/workspace/review",
		patternParts: ["workspace", "review"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
		page: page_exports$4,
		routeHandler: null,
		layouts: [layout_exports$2, layout_exports$1],
		routeSegments: ["workspace", "review"],
		templateTreePositions: [],
		layoutTreePositions: [0, 1],
		templates: [],
		errors: [null, null],
	...
	},
	{
		...
		ids: {
			"route": "route:/workspace/users",
			"page": "page:/workspace/users",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/", "layout:/workspace"],
			"templates": [],
		...
		pattern: "/workspace/users",
		patternParts: ["workspace", "users"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
		page: page_exports$3,
	...
	},
	{
		...
		ids: {
			"route": "route:/case-preview/:caseId",
			"page": "page:/case-preview/:caseId",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
		...
		pattern: "/case-preview/:caseId",
		patternParts: ["case-preview", ":caseId"],
		isDynamic: true,
		params: ["caseId"],
		rootParamNames: [],
		page: page_exports$1,
		routeHandler: null,
		layouts: [layout_exports$2],
		routeSegments: ["case-preview", "[caseId]"],
		templateTreePositions: [],
		layoutTreePositions: [0],
		templates: [],
		errors: [null],
	...
	},
	{
		...
		ids: {
			"route": "route:/media/:key",
			"page": null,
			"routeHandler": "route-handler:/media/:key",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
	...
	},
	{
		...
		ids: {
			"route": "route:/tin-tuc/:slug",
			"page": "page:/tin-tuc/:slug",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
