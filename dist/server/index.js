globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/case-content-types-QL6dA80t.js","assets/navigation-YPWU1MZW.js","assets/road-lab-draft-Dqw3chzx.js","assets/case-preview-BqGdxwzk.js","assets/page-fXWSCieo.js","assets/page-DcgbbhoF.js","assets/case-editor-CHtvTRUr.js","assets/page-CK1uZiM1.js","assets/page-BZUwwaQV.js","assets/page-C8aFcNNQ.js","assets/page-D0NLWWIF.js","assets/page-BWcAFjkI.js","assets/sidebar-BRlxjaT4.js","assets/topbar-DylcpOE_.js","assets/layout-segment-context-Cu6Zfvaa.js","assets/link-JrsU2JrB.js","assets/router-DNZHID0D.js"];
...
import { a as parseFaqs, c as parseMetrics, d as parseTimeline, f as getCaseContentType, h as apiErrorResponse, i as getRoadLabMediaUrls, l as parseQc, m as CaseLabApiError, o as parseFollowup, p as normalizeCaseContentType, r as normalizeCaseDraft, s as parseListLines, u as parseRelated } from "./assets/case-draft-DbhTLwfJ.js";
...
function getDraftSecret() {
	return "bf14420f-85bf-4a27-83fe-0d12f3058ea6";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "fc5a0278-0ec7-4998-8e16-43010f7f0974";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "fc5a0278-0ec7-4998-8e16-43010f7f0974") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "fc5a0278-0ec7-4998-8e16-43010f7f0974",
		rootBoundaryId
	});
}
/**
...
//#endregion
//#region server/password-auth.ts
var HASH_BYTES = 32;
async function verifyPassword(password, encoded) {
	...
	try {
		return constantTimeEqual(fromBase64(hashText), await derive(password, fromBase64(saltText), iterations));
	} catch {
		return false;
	}
}
...
async function GET$10(request, context) {
	try {
		...
		const { listCaseAssignments } = await import("./assets/case-lab-operations-CehJM2ev.js");
...
async function PUT$2(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { assignCaseReviewer } = await import("./assets/case-lab-operations-CehJM2ev.js");
...
var route_exports$16 = /* @__PURE__ */ __exportAll({ GET: () => GET$9 });
async function GET$9(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { listCaseAudit } = await import("./assets/case-lab-operations-CehJM2ev.js");
...
async function GET$8(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { getCaseDraft } = await import("./assets/case-lab-operations-CehJM2ev.js");
...
async function PUT$1(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { saveCaseDraft } = await import("./assets/case-lab-operations-CehJM2ev.js");
...
async function GET$7(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { listCaseFeedback } = await import("./assets/case-lab-operations-CehJM2ev.js");
...
async function POST$6(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { createCaseFeedback } = await import("./assets/case-lab-operations-CehJM2ev.js");
...
var route_exports$13 = /* @__PURE__ */ __exportAll({ PUT: () => PUT });
...
async function PUT(request, context) {
	try {
		const actor = await requireCaseLabActor(request);
		const { caseId } = await context.params;
		const { transitionCaseStatus } = await import("./assets/case-lab-operations-CehJM2ev.js");
...
async function POST$5(request, context) {
	try {
		...
		const { resolveCaseFeedback } = await import("./assets/case-lab-operations-CehJM2ev.js");
...
async function POST$4(request, context) {
	try {
		...
		const { markNotificationRead } = await import("./assets/case-lab-operations-CehJM2ev.js");
...
var page_exports$14 = /* @__PURE__ */ __exportAll({ default: () => page_default$6 });
...
var page_exports$13 = /* @__PURE__ */ __exportAll({ default: () => CaseReviewPage });
...
//#endregion
//#region app/page.tsx
var page_exports$12 = /* @__PURE__ */ __exportAll({ default: () => HomePage });
function HomePage() {
	redirect("/workspace");
}
//#endregion
...
var route_exports$9 = /* @__PURE__ */ __exportAll({ POST: () => POST$2 });
...
var route_exports$7 = /* @__PURE__ */ __exportAll({ POST: () => POST$1 });
async function POST$1(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { createCase } = await import("./assets/case-lab-operations-CehJM2ev.js");
...
async function GET$5(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getDashboard } = await import("./assets/case-lab-operations-CehJM2ev.js");
...
var route_exports$5 = /* @__PURE__ */ __exportAll({ GET: () => GET$4 });
function GET$4() {
...
async function GET$3(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getMyProfile } = await import("./assets/case-lab-operations-CehJM2ev.js");
...
async function PATCH(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { updateMyProfile } = await import("./assets/case-lab-operations-CehJM2ev.js");
...
async function GET$2(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { listMyNotifications } = await import("./assets/case-lab-operations-CehJM2ev.js");
...
var route_exports$2 = /* @__PURE__ */ __exportAll({ GET: () => GET$1 });
async function GET$1(request) {
	try {
		const actor = await requireCaseLabActor(request);
		const { getOperationsReport } = await import("./assets/case-lab-operations-CehJM2ev.js");
...
var page_exports$11 = /* @__PURE__ */ __exportAll({ default: () => page_default$5 });
var page_default$5 = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "b49ea5cf04c0", "default");
//#endregion
//#region app/studio/page.tsx
var page_exports$10 = /* @__PURE__ */ __exportAll({ default: () => StudioPage });
function StudioPage() {
	redirect("/workspace");
}
...
var page_exports$9 = /* @__PURE__ */ __exportAll({ default: () => StudioReviewPage });
...
var page_exports$6 = /* @__PURE__ */ __exportAll({ default: () => GuidesPage });
var guides = [
	[
		"01",
