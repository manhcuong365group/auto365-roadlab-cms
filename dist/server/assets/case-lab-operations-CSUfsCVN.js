import { a as caseRevisions, i as caseFeedback, l as userRoles, o as cases, r as caseAssignments, s as notifications, t as auditEvents, u as users } from "./schema-DgFLUafw.js";
import { a as eq, c as isNull, i as and, n as getDb, r as desc, s as inArray } from "./db-BlSdbD93.js";
import { n as CaseLabApiError, t as normalizeRoadLabDraft } from "./road-lab-draft-CPzFeWGX.js";
...
function contentFromRevision(contentJson, caseItem) {
	try {
		return normalizeRoadLabDraft(JSON.parse(contentJson), {
			vehicleName: caseItem.vehicleRef,
			productName: caseItem.productRef
		});
	} catch {
		return normalizeRoadLabDraft(null, {
			vehicleName: caseItem.vehicleRef,
			productName: caseItem.productRef
		});
	}
