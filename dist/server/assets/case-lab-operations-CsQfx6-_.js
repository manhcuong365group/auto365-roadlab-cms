import { a as caseRevisions, i as caseFeedback, l as userRoles, o as cases, r as caseAssignments, s as notifications, t as auditEvents, u as users } from "./schema-CtdZpCg0.js";
import { a as eq, c as isNull, i as and, n as getDb, r as desc, s as inArray } from "./db-Bek3iEJz.js";
...
function contentFromRevision(contentJson) {
	try {
...
async function getCaseDraft(caseId, actor) {
	...
	return {
		...
		draft: {
			...
			content: contentFromRevision(revision.contentJson),
