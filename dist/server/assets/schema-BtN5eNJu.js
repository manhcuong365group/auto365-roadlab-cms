...
//#endregion
//#region node_modules/drizzle-orm/sqlite-core/primary-keys.js
...
var cases = sqliteTable("cases", {
	...
	contentType: text("content_type", { enum: [
		"case",
		"proof",
		"brand",
		"product"
	] }).notNull().default("case"),
...
//#endregion
export { sql as A, is as B, Placeholder as C, fillPlaceholders as D, View as E, ViewBaseConfig as F, __exportAll as H, Subquery as I, WithSubquery as L, Table as M, getTableName as N, isDriverValueEncoder as O, getTableUniqueName as P, Column as R, Param as S, StringChunk as T, __toESM as U, __commonJSMin as V, getTableLikeName as _, caseRevisions as a, mapUpdateSet as b, schema_exports as c, users as d, workOrders as f, getTableColumns as g, applyMixins as h, caseFeedback as i, Columns as j, isSQLWrapper as k, urlRegistry as l, SQLiteColumn as m, authSessions as n, cases as o, SQLiteTable as p, caseAssignments as r, notifications as s, auditEvents as t, userRoles as u, haveSameKeys as v, SQL as w, orderSelectedFields as x, mapResultRow as y, entityKind as z };
